...
const MOCK_POSTS: Post[] = [
  {
    id: '1',
    user: { name: 'Ana Fitness', profilePicture: 'https://placehold.co/50x50/FFC0CB/000000?text=AF' },
    date: '20 de Maio de 2025',
    description: 'Treino de pernas insano hoje! Quase não consegui andar depois. 🦵🔥',
    exercises: [
  ...
  {
    id: '2',
    user: { name: 'Bruno Força', profilePicture: 'https://placehold.co/50x50/ADD8E6/000000?text=BF' },
    date: '19 de Maio de 2025',
    description: 'Dia de peito e tríceps. Foco na execução e carga progressiva. 💪',
    exercises: [
  ...
  {
    id: '3',
    user: { name: 'Carla Cardio', profilePicture: 'https://placehold.co/50x50/90EE90/000000?text=CC' },
    date: '18 de Maio de 2025',
    description: 'Corrida matinal de 5km e depois um HIIT rápido. Energia total! 🏃‍♀️💨',
    exercises: [
  ...
  return (
    <View style={styles.postCard}>
      <View style={styles.postHeader}>
        <Image source={{ uri: post.user.profilePicture }} style={styles.postProfileImage} />
        <View>
...
export default function FeedScreen() {
  ...
  const handleComment = (postId: string) => {
    Alert.alert('Comentar', `Funcionalidade de comentar no post ${postId} em desenvolvimento.`);
    // Em uma API real: navegar para tela de comentários ou abrir modal
    console.log(`Comentar no post: ${postId}`);
  };

  const handleShare = (postId: string) => {
    Alert.alert('Compartilhar', `Funcionalidade de compartilhar o post ${postId} em desenvolvimento.`);
  ...
  if (isLoading) {
    return (
      <SafeAreaView style={styles.loadingContainer}>
        {isFocused && <StatusBar barStyle="dark-content" backgroundColor="#f0f2f5" />}
