...
// Importa o tipo RootStackParamList do arquivo de login para navegação
import { type RootStackParamList } from './login';

// Define o tipo para o hook useNavigation para esta tela
type ContaScreenNavigationProp = NavigationProp<RootStackParamList, 'MainApp'>;

// Dados mockados do usuário
const MOCK_USER_DATA = {
  name: 'João Silva',
  email: 'joao.silva@example.com',
  profilePicture: 'https://placehold.co/100x100/A0C3FF/000000?text=JS', // Placeholder para imagem de perfil
};
    ...
    <SafeAreaView style={styles.safeAreaContainer}>
      ...
      <View style={styles.section}>
        <TouchableOpacity style={styles.optionButton}>
          <AntDesign name="setting" size={24} color="#555" style={styles.optionIcon} />
          <Text style={styles.optionText}>Configurações da Conta</Text>
          <AntDesign name="right" size={18} color="#999" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionButton}>
          <AntDesign name="lock" size={24} color="#555" style={styles.optionIcon} />
          <Text style={styles.optionText}>Privacidade e Segurança</Text>
          <AntDesign name="right" size={18} color="#999" />
        </TouchableOpacity>
        <TouchableOpacity style={styles.optionButton}>
          <AntDesign name="questioncircleo" size={24} color="#555" style={styles.optionIcon} />
